...
public static class ProductExtension
{
    ...
    {
        if (string.IsNullOrWhiteSpace(orderBy) || string.IsNullOrEmpty(orderBy)) return query.OrderBy(p => p.Name);
    ...
    {
        if (string.IsNullOrWhiteSpace(searchTerm) || string.IsNullOrEmpty(searchTerm)) return query;
